const LANG_DICT = {
    "id": {
        ...
        "info_isolate_cmd": "KHUSUS IP STATIK & RADIUS: Wajib pasang perintah ini di Terminal MikroTik agar isolir berfungsi:\n/ip firewall filter add chain=forward action=drop src-address-list=ISOLIR comment=\"ISOLIR IP STATIK atau PPPOE RADIUS by nms RizkiNet\" place-before=0",
    ...
    "en": {
        ...
        "info_isolate_cmd": "MikroTik Terminal Command: /ip firewall filter add chain=forward action=drop src-address-list=ISOLIR comment=\"ISOLIR IP STATIK by nms RizkiNet\" place-before=0",
        "btn_sync": "SYNC DATA",
